...
public class Calculadora extends JFrame{
    ...
    private void init() {
      ...
      caja = new JTextField();
      caja.setBounds(0,0,300,50);
      panel_principal.add("North",caja);
      panel_botones = new JPanel();
      panel_botones.setLayout(new GridLayout(5,4,10,10));
      agregarBotones();
